...
export default function InsuranceDashboard() {
  return (
    <div className='space-y-6'>
      <PageHeader
        title='Bảng điều khiển Bảo hiểm'
        description='Quản lý yêu cầu bảo hiểm, hợp đồng và thanh toán'>
          ...
          <DashboardTable
            ...
            columns={[
              ...
              },
              {
                ...
                header: "Số tiền",
                cell: (item: any) => (
                  <div>{item.amount.toLocaleString("vi-VN")} ₫</div>
                ),
              },
              {
                key: "type",
          ...
          <DashboardTable
            ...
            columns={[
              ...
              },
              {
                ...
                header: "Chủ hợp đồng",
                cell: (item: any) => (
                  <div className='font-medium'>{item.holderName}</div>
                ),
              },
              {
                key: "policyNumber",
