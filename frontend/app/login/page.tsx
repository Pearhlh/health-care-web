...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const authService = await import("@/lib/api/auth-service").then(
        (mod) => mod.default
      );
      ...
      if (error?.response?.status === 404) {
        errorMessage =
          "Lỗi máy chủ: API đăng nhập không được tìm thấy. Vui lòng liên hệ quản trị viên.";
        ...
        <div className='absolute inset-0 flex items-center justify-center z-20'>
          <div className='max-w-md p-6 text-white'>
            <motion.div
              ...
              <p className='mb-6'>
                Hệ thống y tế thông minh giúp bạn quản lý sức khỏe hiệu quả, kết
                nối với bác sĩ và dịch vụ y tế mọi lúc, mọi nơi.
              </p>
